...
public class LocatorExample {
	...
	public void setup() throws MalformedURLException, URISyntaxException {
		...
		/*
		 * //For IOS XCUITestOptions iosOptions = new XCUITestOptions();
		 * iosOptions.setPlatformName("ios"); iosOptions.setAutomationName("XCUITest");
		 * iosOptions.setApp("/path/to/app.ipa"); iosOptions.noReset();
		 */
