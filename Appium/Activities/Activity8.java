...
public class Activity8 {
	...
	public void scrollIntoViewTest() {
		...
		// Wait for the page to load
		// wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.accessibilityId("Click
		// Me!")));
		wait.until(ExpectedConditions
				.elementToBeClickable(AppiumBy.xpath("//android.widget.Button[@text=\"Open Another One\"]")));

		// Print page title
		String pageTitle = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"This is a New Tab!\"]"))
				.getText();
