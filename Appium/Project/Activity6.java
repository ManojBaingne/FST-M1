...
public class Activity6 {
	...
	public void popupsCard() throws InterruptedException {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath(
				"//android.webkit.WebView[@text=\"Training Support - Selenium\"]/android.view.View[2]/android.view.View[3]")));
		...
		wait.until(
				ExpectedConditions.elementToBeClickable(AppiumBy.xpath("//android.widget.Button[@text=\"Sign In \"]")));
	...
	public void popupsCardValidCredientials() throws InterruptedException {
		...
		// Find the username and password input fields in the popup and enter the
		// following credentials in it:
		// Username: admin Password: password

		wait.until(ExpectedConditions
				.elementToBeClickable(AppiumBy.xpath("//android.widget.EditText[@resource-id=\"username\"]")));
		...
		String msg = driver.findElement(AppiumBy.xpath("//android.view.View[@resource-id=\"action-confirmation\"]"))
				.getText();
